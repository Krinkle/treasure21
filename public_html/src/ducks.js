...
async function main() {
	let encryptedClues = {
		...
		dir: '904119f76e7b5477fedb56e6XNbfTYmmSAMyM93vgsqglJ1LqjGR89bciUqDAWemi/FARRNFWOk26WR+KJdF+mNNXaKqhcgN',
	...
	btnStart.addEventListener('click', async () => {
		let item = appendClue(await decipherClue(encryptedClues.first, firstInputNode.value));
